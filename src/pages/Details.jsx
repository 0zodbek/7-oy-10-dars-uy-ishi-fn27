...
function Details() {
  ...
  return (
    <div className="bg-black min-h-screen text-white pb-24">
      {/* Playlist header */}
      <div className="bg-gradient-to-b from-green-500/30 to-black p-8">
        <div className="flex gap-6">
          ...
          <div>
            ...
            <h1 className="text-7xl font-bold mt-2">{data?.name}</h1>
            <p className="mt-6 text-sm text-gray-300">{data?.description}</p>
          ...
          <tbody>
            {data?.tracks?.items.map((item, index) => (
              ...
              >
                ...
                <td>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                      <span className={`${currentTrack?.id === item.track.id ? 'text-green-500' : 'text-white'}`}>
                        {item.track.name}
                      </span>
                ...
                <td className="text-gray-400">{item.track.album.name}</td>
